...
The **Transparency Completeness Score** = number of complete sections out of 8.
It measures how much you've disclosed. It does **not** measure whether your tool
is good, safe, or trustworthy. Make that distinction loudly in any output.
...
2. The **Transparency Completeness Score** (`N / 8 sections`).
...
4. The **disclose-or-fix punch list** from Part B + the **pitfalls** found in
   Part D, with the shallow-scan caveat.
