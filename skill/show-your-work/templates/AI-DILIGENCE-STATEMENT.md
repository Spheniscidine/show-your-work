<!--
  ...
  Written with help from the Show Your Work self-assessment.
  This describes how this app was built (with AI) and how it's run, so people can
  decide whether to trust it. It is NOT a security audit and does NOT certify the
...
## 2. Who's behind it
- **Who:** <name or handle, and a link to find me>
- **Contact / report an issue:** <email, form, or GitHub issues>
- **Typical response time:** <e.g. "within a few days, this is a side project">
- **Entity:** <an individual / a side project / a registered company>

## 3. What it is, honestly
- **Age & scale:** <how long it's existed, roughly how many users>
- **Maturity:** <hobby / beta / maintained product>
- **Should you rely on it for anything important?** <set the expectation>
- **Uptime/SLA:** <a promise, or explicitly none>

## 4. Data: what's collected and where it goes
- **Collected:** <accounts, content, analytics, payments, …>
- **Stored where:** <provider / region, roughly>
- **Third parties that touch it:** <auth, DB/hosting, analytics, email, payments>
- **Anything sent somewhere unexpected?** <e.g. only if your app has an AI
  feature: which model provider, and what's sent. Otherwise: "nothing beyond the
  above.">
...
- **Roadmap:** <a line or two, or "maintained as-is, no roadmap">
